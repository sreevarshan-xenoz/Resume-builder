...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      {/* Footer */}
      <footer className="w-full py-10 px-4 sm:px-6 lg:px-8 bg-gray-900 text-gray-300">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4 text-white">Resume Builder</h3>
            <p className="mb-4">Creating future-ready resumes with cutting-edge technology.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="mb-2">support@resumebuilder.com</p>
